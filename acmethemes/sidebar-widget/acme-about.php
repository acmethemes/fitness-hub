 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'Fitness_Hub_About' ) ) {

	class Fitness_Hub_About extends WP_Widget {
		...
		function __construct() {
			parent::__construct(
                    ...
                    esc_html__( 'AT About Section', 'fitness-hub' ),
                    /*Widget description*/
                    array(
                            'description' => esc_html__( 'Show About Section with image and description.', 'fitness-hub' )
                    )
			);
		}
		...
		public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'sub_title' ) ); ?>"><?php _e( 'Short Description', 'fitness-hub' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'some_content' ) ); ?>"><?php _e( 'Short Content', 'fitness-hub' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'featured_image' ) ); ?>">
					<?php esc_html_e( 'Select Featured Image', 'fitness-hub' ); ?>
                </label>
				<?php
                ...
                <span class="img-preview-wrap" <?php echo  $fitness_hub_display_none ; ?>>
                    <img class="widefat" src="<?php echo esc_url( $featured_image ); ?>" alt="<?php esc_attr_e( 'Image preview', 'fitness-hub' ); ?>"  />
                ...
                <input type="button" value="<?php esc_attr_e( 'Upload Image', 'fitness-hub' ); ?>" class="button media-image-upload" data-title="<?php esc_attr_e( 'Select Featured Image','fitness-hub'); ?>" data-button="<?php esc_attr_e( 'Select Featured Image','fitness-hub'); ?>"/>
                <input type="button" value="<?php esc_attr_e( 'Remove Image', 'fitness-hub' ); ?>" class="button media-image-remove" />
            </p>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_one_text' ) ); ?>"><?php esc_html_e( 'Extra Button Text', 'fitness-hub' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_one_url' ) ); ?>"><?php esc_html_e( 'Button Link Url', 'fitness-hub' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_two_text' ) ); ?>"><?php esc_html_e( 'Extra Button Text', 'fitness-hub' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'button_two_url' ) ); ?>"><?php esc_html_e( 'Button Link Url', 'fitness-hub' ); ?></label>
	...
	} // Class Fitness_Hub_About ends here
}