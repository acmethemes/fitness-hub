...
if ( ! class_exists( 'Fitness_Hub_Posts_Col' ) ) {
    ...
    class Fitness_Hub_Posts_Col extends WP_Widget {
        ...
        public function form( $instance ) {
	        ...
	        ?>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'unique_id' ) ); ?>"><?php _e( 'Section ID', 'fitness-hub' ); ?>:</label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'content_from' ) ); ?>"><?php _e( 'Content From', 'fitness-hub' ); ?>:</label>
            ...
            <p>
                ...
                <select class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'fitness_hub_img_size' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'fitness_hub_img_size' ) ); ?>">
			        ...
			        foreach( $fitness_hub_image_sizes as $key => $fitness_hub_column_array ){
				        echo ' <option value="'.esc_attr( $key ).'" '.selected( esc_attr( $fitness_hub_img_size ), $key, 0). '>'.esc_html( $fitness_hub_column_array ).'</option>';
			        }
			        ?>
                </select>
            </p>
