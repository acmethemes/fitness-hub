...
if ( ! function_exists( 'fitness_hub_get_theme_options' ) ) :
	function fitness_hub_get_theme_options() {
		...
		// Skip cache during Customizer preview to reflect live updates
		...
		if ( is_array( $fitness_hub_get_theme_options ) ) {
			$cached_theme_options = array_merge( $fitness_hub_default_theme_options, $fitness_hub_get_theme_options );
		} else {
			$cached_theme_options = $fitness_hub_default_theme_options;
		}
